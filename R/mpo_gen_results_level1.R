...
gen_results <- function(ctd,
  ...
  # Run analysis
    ...
    results_list <- lapply(validgenelists,FUN=function(p,
      ...
      results = EWCE::bootstrap_enrichment_test(sct_data = ctd_file,
                                                  hits = genes,
                                                  bg = background,
                                                  reps = bootstrap_reps,
...
#Gene-phenotype associations from phenotyping studies of knockout mice
...
all_results <- gen_results(ctd,
                           ...
                           list_name_column = "Phenotype",
                           gene_column = "Gene",
                           results_dir = "results_test_level1_h_040722",
                           overwrite_past_analysis = FALSE,
                           reps = 100000,
                           annotLevel = 1,
                           genelistSpecies = "human",
